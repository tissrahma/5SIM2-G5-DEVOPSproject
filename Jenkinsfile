    ...
    steps {
        script {
            ...
            dir('/var/lib/jenkins/workspace/ProjetSpring1/DevOps_Project') {
                sh 'mvn verify sonar:sonar -Dsonar.organization=mathlouthikhitem -Dsonar.projectKey=tissrahma_5SIM2-G5-DEVOPSproject -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=6616dafb265809679c6da70758e5b1475871eade'
            }
        }
    }
}
