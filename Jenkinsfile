    ...
    steps {
        script {
            ...
            dir('/var/lib/jenkins/workspace/ProjetSpring1/DevOps_Project') {
                sh 'mvn verify sonar:sonar -Dsonar.organization=mathlouthikhitem -Dsonar.projectKey=mathlouthikhitem_5SIM2-G5-DEVOPSproject -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=d95a96914938ef308a0dec636aca2a5c56fe6571'
            }
        }
    }
}
